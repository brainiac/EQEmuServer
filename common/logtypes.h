...
LOG_CATEGORY( UTILSERVER )
LOG_TYPE( UTILSERVER, INIT, ENABLED )
LOG_TYPE( UTILSERVER, ERROR, ENABLED )
LOG_TYPE( UTILSERVER, CLIENT, DISABLED )
LOG_TYPE( UTILSERVER, TRACE, DISABLED )
LOG_TYPE( UTILSERVER, PACKETS, DISABLED)
