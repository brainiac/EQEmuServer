...
OPCODE(OP_PlayEverquestResponse,        0x0023)
OPCODE(OP_ChatMessage,                  0x0018)
OPCODE(OP_LoginAccepted,                0x0019)
OPCODE(OP_ServerListResponse,           0x001a)
OPCODE(OP_Poll,                         0x002a)
OPCODE(OP_EnterChat,                    0x000f)
OPCODE(OP_PollResponse,                 0x0011)
OPCODE(OP_SystemFingerprint,            0x0016)
OPCODE(OP_ExpansionList,                0x0031)
